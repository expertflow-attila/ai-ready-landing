        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-start">
          ...
          <AnimateOnScroll direction="left" className="md:col-span-4">
            <div className="max-w-[300px] mx-auto md:mx-0">
              <div className="aspect-[3/4] rounded-2xl bg-bg-subtle border border-border-subtle flex items-center justify-center overflow-hidden">
                <div className="text-center p-8">
                  <div className="w-20 h-20 rounded-full bg-accent-subtle mx-auto mb-3 flex items-center justify-center border border-accent/20">
                    <span className="font-heading text-[24px] font-bold text-accent">NA</span>
                  </div>
                  <span className="font-body text-[12px] text-text-disabled">Fotó</span>
                </div>
              </div>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll direction="right" className="md:col-span-8">
            ...
            <h2
              className="font-heading font-bold text-[30px] md:text-[40px] leading-[1.05] tracking-[-0.02em] text-text-primary mb-1.5"
              style={{ textWrap: "balance" }}
            >
              {INSTRUCTOR.name}
            </h2>
            <p className="font-body text-[13px] font-medium text-accent mb-8">
              {INSTRUCTOR.title}
            </p>
            ...
            <blockquote className="mt-10 pl-6 border-l-2 border-accent">
              <p className="font-heading italic text-[22px] text-accent leading-[1.4]">
